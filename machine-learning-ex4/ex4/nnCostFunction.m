...
for t = 1:m
	...
	del_1 = del_1 + d_2(2 : end) * a_1_t;
	del_2 = del_2 + d_3' * a_2_t;
end

Theta1_grad = (1 / m) * del_1 + (lambda / m) * [zeros(size(Theta1, 1), 1) regTheta1];
Theta2_grad = (1 / m) * del_2 + (lambda / m) * [zeros(size(Theta2, 1), 1) regTheta2];  
